<div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
    <div class="flex items-center gap-5 mb-10">
        ...
        <div>
            ...
            <p class="text-sm text-gray-400">Selesaikan event dan upload gambar
                dokumentasi</p>
        </div>
    </div>
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white p-10 rounded-[3rem] shadow-sm border border-gray-100">
                <div class="flex justify-between items-center mb-8">
                    ...
                    <label
                        class="px-5 py-2 bg-gray-900 text-white rounded-xl text-[10px] font-black uppercase cursor-pointer hover:bg-black transition">
                        + Tambah Foto
                        <input type="file" wire:model="gallery_photos" multiple class="hidden">
                    </label>
                </div>

                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    @foreach ($event->images as $img)
                        <div class="group relative aspect-square rounded-[2rem] overflow-hidden border border-gray-100">
        ...
        <div class="space-y-6">
            <div class="bg-white p-6 rounded-[2.5rem] shadow-sm border border-gray-100 text-center">
                <label class="text-[10px] font-black text-gray-400 uppercase block mb-4 tracking-widest">Cover
                    Utama</label>
                <div
                    class="aspect-[3/4] rounded-[2rem] overflow-hidden bg-gray-50 border-4 border-white shadow-lg mb-6">
                    @if ($new_cover)
                ...
                <label
                    class="block w-full py-3 bg-amber-50 text-amber-600 rounded-xl font-black text-[10px] uppercase cursor-pointer border border-amber-100">
                    Ganti Cover
                    <input type="file" wire:model="new_cover" class="hidden">
                </label>
            </div>
        </div>
    </div>
