...
class Form extends Component
{
    ...
    // Properti Produk (Disesuaikan dengan Schema: name, image_url, display)
    public $product_name_1, $product_image_1, $product_display_1 = false;
    public $product_name_2, $product_image_2, $product_display_2 = false;

    // Properti Tracking ID
    ...
    public function save()
    {
        ...
        // Mengirim menggunakan multiple_text namun dilakukan satu per satu di dalam loop agar bisa dijeda
        foreach ($waData as $singleWa) {
            // Bungkus satu pesan ke dalam array karena multiple_text mengharuskan input berupa array dari array
